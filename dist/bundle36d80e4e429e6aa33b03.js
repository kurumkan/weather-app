...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__getIn__ = __webpack_require__(283);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__setIn__ = __webpack_require__(308);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__deepEqual__ = __webpack_require__(309);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__deleteIn__ = __webpack_require__(344);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__keys__ = __webpack_require__(345);
...
exports.notifyClientStatusChange = exports.setActiveClients = exports.signinUser = exports.signupUser = exports.signoutUser = exports.authUser = exports.updateUser = exports.getUser = exports.getUsers = undefined;
...
var getUsers = exports.getUsers = function getUsers() {
  ...
  return function (dispatch, getState) {
    dispatch({ type: _actionTypes.GET_USERS_REQUEST });

    _api2.default.getUsers(offset, limit).then(function (res) {
      dispatch({
...
var getUser = exports.getUser = function getUser(username) {
  return function (dispatch, getState) {
    dispatch({ type: _actionTypes.GET_USER_REQUEST });

    _api2.default.getUser(username).then(function (res) {
      dispatch({
        type: _actionTypes.GET_USER_SUCCESS,
        payload: res.data.user
      });
    }).catch(function (e) {
      dispatch({
        type: _actionTypes.GET_USER_FAILURE,
...
var updateUser = exports.updateUser = function updateUser(username) {
  return function (dispatch, getState) {
    dispatch({ type: _actionTypes.UPDATE_USER_REQUEST });
    var data = getState().form.updateUser.values;
    _api2.default.updateUser(username, data).then(function (res) {
      localStorage.setItem('firstName', data.firstName);
      localStorage.setItem('lastName', data.lastName);
      localStorage.setItem('imageUrl', data.imageUrl);
      dispatch({
        type: _actionTypes.UPDATE_USER_SUCCESS,
        payload: data
      });
      dispatch(getUsers());
    }).catch(function (e) {
      dispatch({
        type: _actionTypes.UPDATE_USER_FAILURE,
        payload: 'Cannot load the user'
      });
    });
  };
...
var authUser = exports.authUser = function authUser(_ref) {
  ...
  return function (dispatch) {
    ...
    dispatch({ type: _actionTypes.AUTH_USER, payload: { userid: userid, firstName: firstName, lastName: lastName, imageUrl: imageUrl, username: username }, meta: { remote: true } });
...
var signoutUser = exports.signoutUser = function signoutUser() {
  return function (dispatch) {
    ...
    dispatch({ type: _actionTypes.UNAUTH_USER, meta: { remote: true } });
  };
};

var signupUser = exports.signupUser = function signupUser() {
  return function (dispatch, getState) {
    var _getState$form$signup = getState().form.signup.values,
        firstName = _getState$form$signup.firstName,
        lastName = _getState$form$signup.lastName,
        username = _getState$form$signup.username,
        email = _getState$form$signup.email,
        password = _getState$form$signup.password,
        imageUrl = _getState$form$signup.imageUrl;

    return _api2.default.signupUser({ firstName: firstName, lastName: lastName, username: username, email: email, password: password, imageUrl: imageUrl }).then(function (response) {
      ...
      dispatch({
        type: _actionTypes.SIGNUP_ERROR,
        payload: message
      });
    });
  };
...
var signinUser = exports.signinUser = function signinUser() {
  return function (dispatch, getState) {
    var _getState$form$signin = getState().form.signin.values,
        login = _getState$form$signin.login,
        password = _getState$form$signin.password;

    _api2.default.signinUser({ login: login, password: password }).then(function (response) {
      return dispatch(authUser(response.data));
    }).catch(function (e) {
      var message = 'Sorry something went wrong';
      ...
      dispatch({
        type: _actionTypes.SIGNIN_ERROR,
        payload: message
      });
    });
  };
...
var setActiveClients = exports.setActiveClients = function setActiveClients(usersOnline) {
  return function (dispatch) {
    dispatch({ type: _actionTypes.SET_ACTIVE_USERS, payload: usersOnline });
  };
};

var notifyClientStatusChange = exports.notifyClientStatusChange = function notifyClientStatusChange(username, isOnline) {
  return function (dispatch) {
    dispatch({ type: _actionTypes.CHANGE_USER_STATE, payload: { username: username, isOnline: isOnline } });
  };
};
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baseIsNative_js__ = __webpack_require__(289);
...
var UPDATE_USER_REQUEST = exports.UPDATE_USER_REQUEST = 'UPDATE_USER_REQUEST';
...
var SIGNIN_ERROR = exports.SIGNIN_ERROR = 'SIGNIN_ERROR';
var AUTH_USER = exports.AUTH_USER = 'AUTH_USER';
var UNAUTH_USER = exports.UNAUTH_USER = 'UNAUTH_USER';

var SET_ACTIVE_USERS = exports.SET_ACTIVE_USERS = 'SET_ACTIVE_USERS';
var CHANGE_USER_STATE = exports.CHANGE_USER_STATE = 'CHANGE_USER_STATE';
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__actionTypes__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__defaultShouldAsyncValidate__ = __webpack_require__(124);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__defaultShouldValidate__ = __webpack_require__(125);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__defaultShouldError__ = __webpack_require__(126);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__defaultShouldWarn__ = __webpack_require__(127);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Form__ = __webpack_require__(273);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__FormSection__ = __webpack_require__(274);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__SubmissionError__ = __webpack_require__(128);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__propTypes__ = __webpack_require__(276);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__Field__ = __webpack_require__(277);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__Fields__ = __webpack_require__(346);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__FieldArray__ = __webpack_require__(349);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__formValueSelector__ = __webpack_require__(367);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__formValues__ = __webpack_require__(369);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__getFormError__ = __webpack_require__(371);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__getFormNames__ = __webpack_require__(373);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__getFormValues__ = __webpack_require__(375);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__getFormInitialValues__ = __webpack_require__(377);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__getFormSyncErrors__ = __webpack_require__(379);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__getFormMeta__ = __webpack_require__(381);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__getFormAsyncErrors__ = __webpack_require__(383);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__getFormSyncWarnings__ = __webpack_require__(385);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__getFormSubmitErrors__ = __webpack_require__(387);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__isDirty__ = __webpack_require__(389);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__isInvalid__ = __webpack_require__(391);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__isPristine__ = __webpack_require__(394);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__isValid__ = __webpack_require__(395);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__isSubmitting__ = __webpack_require__(396);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__hasSubmitSucceeded__ = __webpack_require__(398);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__hasSubmitFailed__ = __webpack_require__(400);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__reduxForm__ = __webpack_require__(402);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__reducer__ = __webpack_require__(433);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__values__ = __webpack_require__(436);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__getNative_js__ = __webpack_require__(17);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__listCacheClear_js__ = __webpack_require__(297);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__listCacheDelete_js__ = __webpack_require__(298);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__listCacheGet_js__ = __webpack_require__(299);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__listCacheHas_js__ = __webpack_require__(300);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__listCacheSet_js__ = __webpack_require__(301);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__isKeyable_js__ = __webpack_require__(303);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mapCacheClear_js__ = __webpack_require__(286);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__mapCacheDelete_js__ = __webpack_require__(302);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mapCacheGet_js__ = __webpack_require__(304);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mapCacheHas_js__ = __webpack_require__(305);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mapCacheSet_js__ = __webpack_require__(306);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baseIsEqualDeep_js__ = __webpack_require__(310);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__isObjectLike_js__ = __webpack_require__(15);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__stackClear_js__ = __webpack_require__(311);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__stackDelete_js__ = __webpack_require__(312);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__stackGet_js__ = __webpack_require__(313);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__stackHas_js__ = __webpack_require__(314);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__stackSet_js__ = __webpack_require__(315);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__baseKeys_js__ = __webpack_require__(337);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baseIsArguments_js__ = __webpack_require__(332);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__isObjectLike_js__ = __webpack_require__(15);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__stubFalse_js__ = __webpack_require__(333);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baseIsTypedArray_js__ = __webpack_require__(334);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__baseUnary_js__ = __webpack_require__(335);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__nodeUtil_js__ = __webpack_require__(336);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__hasError__ = __webpack_require__(393);
...
var json = __webpack_require__(462);
...
var _reactRouterScroll = __webpack_require__(112);
...
var _store = __webpack_require__(449);
...
var store = exports.store = (0, _store2.default)(_reactRouter.browserHistory);
...
if (token) {
  ...
  store.dispatch({ type: _actionTypes.AUTH_USER, payload: { userid: userid, firstName: firstName, lastName: lastName, username: username, imageUrl: imageUrl }, meta: { remote: true } });
}
...
var Loader = function Loader() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'div',
      { className: 'loader' },
      _react2.default.createElement('div', { className: 'loader-inner-circle' }),
      _react2.default.createElement('div', { className: 'loader-inner-circle' }),
      _react2.default.createElement('div', { className: 'loader-inner-circle' }),
      _react2.default.createElement('div', { className: 'loader-inner-circle' })
    )
...
module.exports = "data:image/jpeg;base64,"
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_es6_error__ = __webpack_require__(275);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__memoizeCapped_js__ = __webpack_require__(284);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baseToString_js__ = __webpack_require__(307);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SetCache_js__ = __webpack_require__(316);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__arraySome_js__ = __webpack_require__(319);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__cacheHas_js__ = __webpack_require__(320);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baseTimes_js__ = __webpack_require__(331);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__createBaseFor_js__ = __webpack_require__(353);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baseAssignValue_js__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__eq_js__ = __webpack_require__(26);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__arrayLikeKeys_js__ = __webpack_require__(141);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__baseKeysIn_js__ = __webpack_require__(416);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__isArrayLike_js__ = __webpack_require__(44);
...
var on = __webpack_require__(166);
...
var Transport = __webpack_require__(84);
var parseqs = __webpack_require__(86);
var parser = __webpack_require__(23);
...
var parser = __webpack_require__(82);
var Emitter = __webpack_require__(165);
var toArray = __webpack_require__(485);
var on = __webpack_require__(166);
var bind = __webpack_require__(167);
...
var _UsersListContainer = __webpack_require__(264);

var _UsersListContainer2 = _interopRequireDefault(_UsersListContainer);

var _ProfileContainer = __webpack_require__(268);
...
var _SigninContainer = __webpack_require__(440);

var _SigninContainer2 = _interopRequireDefault(_SigninContainer);

var _ProfileEditContainer = __webpack_require__(443);

var _ProfileEditContainer2 = _interopRequireDefault(_ProfileEditContainer);

var _NotFound = __webpack_require__(446);

var _NotFound2 = _interopRequireDefault(_NotFound);

var _RequireAuth = __webpack_require__(448);
...
var createRoutes = function createRoutes(store) {
  var routes = [{
    ...
    childRoutes: [{
      ...
      component: (0, _RequireAuth2.default)(_ProfileEditContainer2.default)
    }, {
      path: 'users/:username',
      component: (0, _RequireAuth2.default)(_ProfileContainer2.default)
    }, {
      path: 'users',
      component: (0, _RequireAuth2.default)(_UsersListContainer2.default)
    }, {
      path: 'signup',
      component: _SignupContainer2.default
    }, {
      path: 'signin',
      component: _SigninContainer2.default
    }, {
      path: '*',
...
var _usersActions = __webpack_require__(16);
...
var actions = {
  signoutUser: _usersActions.signoutUser
};

exports.default = (0, _reactRedux.connect)(select, actions)(_Header2.default);
...
var _reactFontawesome = __webpack_require__(114);
...
module.exports = __webpack_require__.p + "17127080f828cd14d14a92c7e4587085.jpg";
...
exports.signinUser = exports.signupUser = exports.updateUser = exports.getUser = exports.getUsers = undefined;
...
var ROOT_URL = '/api/users/';

var getUsers = exports.getUsers = function getUsers() {
  var offset = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
  var limit = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 10;
  return _axios2.default.get(ROOT_URL + '?offset=' + offset + '&limit=' + limit);
};

var getUser = exports.getUser = function getUser(username) {
  return _axios2.default.get('' + ROOT_URL + username);
};

var updateUser = exports.updateUser = function updateUser(username, data) {
  return _axios2.default.put(ROOT_URL + '/' + username, data);
};

var signupUser = exports.signupUser = function signupUser(data) {
  return _axios2.default.post('/api/auth/signup', data);
};

var signinUser = exports.signinUser = function signinUser(data) {
  return _axios2.default.post('/api/auth/signin', data);
};
...
var _UsersList = __webpack_require__(265);
...
exports.default = (0, _reactRedux.connect)(select, actions)(_UsersList2.default);
...
var UsersList = function (_Component) {
  ...
  function UsersList() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = UsersList.__proto__ || Object.getPrototypeOf(UsersList)).call.apply(_ref, [this].concat(args))), _this), _this.renderUsers = function (users) {
      return users.map(function (user) {
        var status = _this.props.activeUsers.indexOf(user.username) < 0 ? 'offline' : 'online';
        return _react2.default.createElement(
          'div',
          { key: user._id, className: 'users-list-item' },
          _react2.default.createElement(
            _reactRouter.Link,
            { to: 'users/' + user.username + '/', className: 'user-link' },
            _react2.default.createElement(
              'div',
              { className: 'img-wrapper' },
              _react2.default.createElement('img', { src: user.imageUrl || _default2.default })
            ),
            _react2.default.createElement(
              'div',
              { className: 'user-info' },
...
var select = function select(state) {
  var _state$users$currentU = state.users.currentUser,
      username = _state$users$currentU.username,
      firstName = _state$users$currentU.firstName,
      lastName = _state$users$currentU.lastName,
      imageUrl = _state$users$currentU.imageUrl;
  var _state$users = state.users,
      activeUsers = _state$users.activeUsers,
      gettingAUser = _state$users.gettingAUser;

  return { username: username, firstName: firstName, lastName: lastName, imageUrl: imageUrl, activeUsers: activeUsers, gettingAUser: gettingAUser };
};

var actions = {
  getUser: _usersActions.getUser
};

exports.default = (0, _reactRedux.connect)(select, actions)(_Profile2.default);
  ...
  _createClass(Profile, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          gettingAUser = _props.gettingAUser;

      var status = activeUsers.indexOf(username) < 0 ? 'offline' : 'online';
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'profile' },
          _react2.default.createElement('img', { src: imageUrl || _default2.default }),
          _react2.default.createElement(
            'div',
            null,
            _react2.default.createElement(
...
var actions = {
  signupUser: _usersActions.signupUser
};
...
var validate = function validate(fromProps) {
  var errors = {};
...
var Signup = function (_React$Component) {
  ...
  function Signup() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Signup.__proto__ || Object.getPrototypeOf(Signup)).call.apply(_ref, [this].concat(args))), _this), _this.handleSubmit = function (e) {
      _this.props.signupUser();
  ...
  _createClass(Signup, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Alert2.default, { message: this.props.authError }),
        _react2.default.createElement(
          'form',
          { onSubmit: this.props.handleSubmit(this.handleSubmit) },
          _react2.default.createElement(_reduxForm.Field, { name: 'username', component: this.renderField, label: 'Username' }),
          _react2.default.createElement(_reduxForm.Field, { name: 'email', type: 'email', component: this.renderField, label: 'Email' }),
          _react2.default.createElement(_reduxForm.Field, { name: 'firstName', component: this.renderField, label: 'First Name' }),
          _react2.default.createElement(_reduxForm.Field, { name: 'lastName', component: this.renderField, label: 'Last Name' }),
          _react2.default.createElement(_reduxForm.Field, { name: 'imageUrl', component: this.renderField, label: 'Profile image url' }),
          _react2.default.createElement(_reduxForm.Field, { name: 'password', type: 'password', component: this.renderField, label: 'Password' }),
          _react2.default.createElement(_reduxForm.Field, { name: 'passwordConfirm', type: 'password', component: this.renderField, label: 'Confirm Password' }),
          _react2.default.createElement(
            'div',
            { className: 'text-center' },
            _react2.default.createElement(
              'button',
              { type: 'submit', disabled: this.props.submitting, className: 'btn' },
              'Submit'
            )
          )
        )
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__util_prefixName__ = __webpack_require__(25);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__createField__ = __webpack_require__(278);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ConnectedField__ = __webpack_require__(279);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__util_eventConsts__ = __webpack_require__(281);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__structure_plain__ = __webpack_require__(1);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__memoize_js__ = __webpack_require__(285);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__MapCache_js__ = __webpack_require__(66);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Hash_js__ = __webpack_require__(287);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__hashClear_js__ = __webpack_require__(288);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__hashDelete_js__ = __webpack_require__(293);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__hashGet_js__ = __webpack_require__(294);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__hashHas_js__ = __webpack_require__(295);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__hashSet_js__ = __webpack_require__(296);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__coreJsData_js__ = __webpack_require__(291);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Stack_js__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__equalArrays_js__ = __webpack_require__(139);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__equalByTag_js__ = __webpack_require__(321);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__equalObjects_js__ = __webpack_require__(324);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__getTag_js__ = __webpack_require__(339);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__isArray_js__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__isBuffer_js__ = __webpack_require__(73);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ListCache_js__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Map_js__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__MapCache_js__ = __webpack_require__(66);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__MapCache_js__ = __webpack_require__(66);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__setCacheAdd_js__ = __webpack_require__(317);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__setCacheHas_js__ = __webpack_require__(318);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__eq_js__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__equalArrays_js__ = __webpack_require__(139);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mapToArray_js__ = __webpack_require__(322);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__setToArray_js__ = __webpack_require__(323);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__getAllKeys_js__ = __webpack_require__(325);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baseGetAllKeys_js__ = __webpack_require__(326);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__getSymbols_js__ = __webpack_require__(328);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__keys_js__ = __webpack_require__(71);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__arrayPush_js__ = __webpack_require__(327);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__arrayFilter_js__ = __webpack_require__(329);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__stubArray_js__ = __webpack_require__(330);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__freeGlobal_js__ = __webpack_require__(93);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__nativeKeys_js__ = __webpack_require__(338);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__DataView_js__ = __webpack_require__(340);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Map_js__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Promise_js__ = __webpack_require__(341);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Set_js__ = __webpack_require__(342);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__WeakMap_js__ = __webpack_require__(343);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__baseGetTag_js__ = __webpack_require__(19);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__createFields__ = __webpack_require__(347);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__structure_plain__ = __webpack_require__(1);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_invariant__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_invariant___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_invariant__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ConnectedFields__ = __webpack_require__(348);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__util_shallowCompare__ = __webpack_require__(142);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__structure_plain__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__util_prefixName__ = __webpack_require__(25);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__createFieldArray__ = __webpack_require__(350);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__structure_plain__ = __webpack_require__(1);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_invariant__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_invariant___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_invariant__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ConnectedFieldArray__ = __webpack_require__(351);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_redux__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__createFieldArrayProps__ = __webpack_require__(366);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__structure_plain__ = __webpack_require__(1);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__keys_js__ = __webpack_require__(71);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baseMatches_js__ = __webpack_require__(355);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__baseMatchesProperty_js__ = __webpack_require__(358);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__property_js__ = __webpack_require__(363);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baseIsMatch_js__ = __webpack_require__(356);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__getMatchData_js__ = __webpack_require__(357);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baseIsEqual_js__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__get_js__ = __webpack_require__(359);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__hasIn_js__ = __webpack_require__(360);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__hasPath_js__ = __webpack_require__(362);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baseProperty_js__ = __webpack_require__(364);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__basePropertyDeep_js__ = __webpack_require__(365);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__createFormValueSelector__ = __webpack_require__(368);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__structure_plain__ = __webpack_require__(1);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__createFormValues__ = __webpack_require__(370);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__structure_plain__ = __webpack_require__(1);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react_redux__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__util_prefixName__ = __webpack_require__(25);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__selectors_getFormError__ = __webpack_require__(372);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__structure_plain__ = __webpack_require__(1);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__selectors_getFormNames__ = __webpack_require__(374);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__structure_plain__ = __webpack_require__(1);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__selectors_getFormValues__ = __webpack_require__(376);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__structure_plain__ = __webpack_require__(1);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__selectors_getFormInitialValues__ = __webpack_require__(378);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__structure_plain__ = __webpack_require__(1);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__selectors_getFormSyncErrors__ = __webpack_require__(380);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__structure_plain__ = __webpack_require__(1);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__selectors_getFormMeta__ = __webpack_require__(382);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__structure_plain__ = __webpack_require__(1);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__selectors_getFormAsyncErrors__ = __webpack_require__(384);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__structure_plain__ = __webpack_require__(1);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__selectors_getFormSyncWarnings__ = __webpack_require__(386);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__structure_plain__ = __webpack_require__(1);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__selectors_getFormSubmitErrors__ = __webpack_require__(388);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__structure_plain__ = __webpack_require__(1);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__selectors_isDirty__ = __webpack_require__(390);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__structure_plain__ = __webpack_require__(1);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__selectors_isInvalid__ = __webpack_require__(392);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__structure_plain__ = __webpack_require__(1);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__selectors_isSubmitting__ = __webpack_require__(397);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__structure_plain__ = __webpack_require__(1);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__selectors_hasSubmitSucceeded__ = __webpack_require__(399);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__structure_plain__ = __webpack_require__(1);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__selectors_hasSubmitFailed__ = __webpack_require__(401);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__structure_plain__ = __webpack_require__(1);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__createReduxForm__ = __webpack_require__(403);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__structure_plain__ = __webpack_require__(1);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_es_merge__ = __webpack_require__(404);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_is_promise__ = __webpack_require__(81);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__actions__ = __webpack_require__(123);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__asyncValidation__ = __webpack_require__(427);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__defaultShouldAsyncValidate__ = __webpack_require__(124);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__defaultShouldValidate__ = __webpack_require__(125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__defaultShouldError__ = __webpack_require__(126);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__defaultShouldWarn__ = __webpack_require__(127);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__events_silenceEvent__ = __webpack_require__(153);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__events_silenceEvents__ = __webpack_require__(428);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__generateValidator__ = __webpack_require__(429);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__handleSubmit__ = __webpack_require__(430);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__selectors_isValid__ = __webpack_require__(80);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__structure_plain__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__util_getDisplayName__ = __webpack_require__(431);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__util_isHotReloading__ = __webpack_require__(432);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baseMerge_js__ = __webpack_require__(405);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__createAssigner_js__ = __webpack_require__(418);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__baseMergeDeep_js__ = __webpack_require__(406);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__isObject_js__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__cloneBuffer_js__ = __webpack_require__(407);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__cloneTypedArray_js__ = __webpack_require__(408);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__copyArray_js__ = __webpack_require__(134);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__initCloneObject_js__ = __webpack_require__(410);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__isArguments_js__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__isArray_js__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__isArrayLikeObject_js__ = __webpack_require__(412);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__isBuffer_js__ = __webpack_require__(73);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__isFunction_js__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__isObject_js__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__isPlainObject_js__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__isTypedArray_js__ = __webpack_require__(75);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__toPlainObject_js__ = __webpack_require__(413);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__cloneArrayBuffer_js__ = __webpack_require__(409);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baseCreate_js__ = __webpack_require__(411);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__copyObject_js__ = __webpack_require__(414);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__assignValue_js__ = __webpack_require__(415);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__nativeKeysIn_js__ = __webpack_require__(417);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baseRest_js__ = __webpack_require__(419);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__isIterateeCall_js__ = __webpack_require__(426);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__overRest_js__ = __webpack_require__(420);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__setToString_js__ = __webpack_require__(422);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__apply_js__ = __webpack_require__(421);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baseSetToString_js__ = __webpack_require__(423);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shortOut_js__ = __webpack_require__(425);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__constant_js__ = __webpack_require__(424);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__isObject_js__ = __webpack_require__(14);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__createReducer__ = __webpack_require__(434);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__structure_plain__ = __webpack_require__(1);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__actionTypes__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__deleteInWithCleanUp__ = __webpack_require__(435);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__createValues__ = __webpack_require__(437);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__structure_plain__ = __webpack_require__(1);
...
var _Signin = __webpack_require__(441);
...
var actions = {
  signinUser: _usersActions.signinUser
};

exports.default = (0, _reactRedux.connect)(select, actions)(_Signin2.default);
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'form',
          { onSubmit: this.props.handleSubmit(this.handleSubmit) },
          _react2.default.createElement(_reduxForm.Field, { name: 'login', component: this.renderField, label: 'Username or Email' }),
          _react2.default.createElement(_reduxForm.Field, { name: 'password', type: 'password', component: this.renderField, label: 'Password' }),
          _react2.default.createElement(
            'div',
            { className: 'text-center' },
...
var _ProfileEdit = __webpack_require__(444);
...
var actions = {
  updateUser: _usersActions.updateUser
};

exports.default = (0, _reactRedux.connect)(select, actions)(_ProfileEdit2.default);
...
var Profile = function (_React$Component) {
  ...
  function Profile() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Profile.__proto__ || Object.getPrototypeOf(Profile)).call.apply(_ref, [this].concat(args))), _this), _this.handleSubmit = function (e) {
      e.preventDefault();
      var _this$props = _this.props,
  ...
  _createClass(Profile, [{
    ...
    value: function componentDidMount() {
      if (this.props.username !== this.props.params.username) {
        _reactRouter.browserHistory.push('/users/' + this.props.username + '/edit');
      }
    }
  }, {
    key: 'render',
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'button',
              { type: 'submit', disabled: submitting, className: 'btn' },
              'Save'
            )
          )
        )
...
var _remoteActionsMiddleWare = __webpack_require__(453);

var _remoteActionsMiddleWare2 = _interopRequireDefault(_remoteActionsMiddleWare);

var _socketClient = __webpack_require__(454);
...
var configureStore = function configureStore(history) {
  var middleware = [_reduxThunk2.default, (0, _remoteActionsMiddleWare2.default)(_socketClient2.default), (0, _reactRouterRedux.routerMiddleware)(history)];
...
var _usersReducer = __webpack_require__(451);

var _usersReducer2 = _interopRequireDefault(_usersReducer);

var _authReducer = __webpack_require__(452);
...
var usersReducer = function usersReducer() {
  ...
  switch (action.type) {
    case _actionTypes.GET_USERS_REQUEST:
      {
    ...
    case _actionTypes.GET_USER_REQUEST:
      {
        return _extends({}, state, {
          gettingAUser: true
        });
    ...
    case _actionTypes.GET_USER_SUCCESS:
      {
        return _extends({}, state, {
    ...
    case _actionTypes.GET_USER_FAILURE:
      {
        return _extends({}, state, {
          gettingAUser: false
        });
      }
    case _actionTypes.SET_ACTIVE_USERS:
      {
        return _extends({}, state, { activeUsers: action.payload });
      }
    case _actionTypes.CHANGE_USER_STATE:
      {
        var activeUsers = [].concat(_toConsumableArray(state.activeUsers));
        var _action$payload = action.payload,
            username = _action$payload.username,
            isOnline = _action$payload.isOnline;
        ...
        return _extends({}, state, { activeUsers: activeUsers });
      }
    default:
      {
        return state;
...
exports.default = function () {
  ...
  switch (action.type) {
    case _actionTypes.AUTH_USER:
      return _extends({
        authenticated: true
      }, action.payload, {
        error: ''
      });
    case _actionTypes.UNAUTH_USER:
      return _extends({}, INIT_STATE);
    case _actionTypes.SIGNIN_ERROR:
      return _extends({}, INIT_STATE, { error: { signin: action.payload } });
    case _actionTypes.SIGNUP_ERROR:
      return _extends({}, INIT_STATE, { error: { signup: action.payload } });
    case _actionTypes.UPDATE_USER_SUCCESS:
...
var _socket = __webpack_require__(455);
...
var API_URL =  true ? window.location.host : 'http://localhost:5000';
var socket = (0, _socket2.default)(API_URL);

socket.on('SET_ACTIVE_CLIENTS', function (data) {
  _index.store.dispatch((0, _usersActions.setActiveClients)(Object.values(data)));
});

socket.on('CLIENT_CONNECTED', function (username) {
  _index.store.dispatch((0, _usersActions.notifyClientStatusChange)(username, true));
});

socket.on('CLIENT_DISCONNECTED', function (username) {
  _index.store.dispatch((0, _usersActions.notifyClientStatusChange)(username, false));
});
...
var parser = __webpack_require__(82);
var Manager = __webpack_require__(158);
...
exports.Manager = __webpack_require__(158);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(52)(module), __webpack_require__(4)))
...
Socket.Transport = __webpack_require__(84);
